...
foreach ($activeMap as $key => $value) {
    ...
    return function () {
    pickUpClick(feature.pickingId, feature.latitudes, feature.longitudes, directionsService, directionsDisplay);
...
foreach ($activeMap as $key => $value) {
    ...
    function pickUpClick(pickingId, latitudes, longitudes, directionsService, directionsDisplay){
    alert(pickingId);
