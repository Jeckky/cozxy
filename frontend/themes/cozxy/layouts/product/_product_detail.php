        ...
        <div class="col-md-8 product-gallery">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    ?>">
                        <img <?php if (GetBrowser::UserAgent() == "computer") { ?>id="zoom-img"<?php } else { ?>id="img-big"<?php } ?> src="<?php echo $model['image'] ?>" class="fullwidth" alt="" <?php if (GetBrowser::UserAgent() == "computer") { ?>data-zoom-image="<?php echo $model['image']; ?>"<?php } ?>>
                        </div>
                    </div>
                    <div class="col-xs-12">
