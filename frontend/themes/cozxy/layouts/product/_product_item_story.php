    ...
    <div class="product-box" style="padding-right: 0px; padding-left: 0px;">
        ...
        <div class="product-txt">
            ...
            <p class="price" style="height:25px;">
                <span class="col-md-4 col-sm-6 col-xs-6" style="padding-right: 0px;"><i class="fa fa-eye"></i> <?= $model->countView() ?></span>
                <span class="col-md-4 col-sm-6 col-xs-6"><i class="fa fa-star"></i> <?= $model->averageStar() ?></span>
            </p>
        </div>
