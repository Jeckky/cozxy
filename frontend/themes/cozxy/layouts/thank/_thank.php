<div class="container login-box">
    ...
    <div class="row">
        ...
        if (isset($_GET['status'])) {
            echo '<div class="col-xs-12 bg-yellow1 b" style="padding:18px 18px 10px;">
                            <p class="size20 size18-xs">Signup Thank</p>
                      </div>';
            echo '<div class="col-xs-12 bg-white size18 b" style="padding: 20px;">';
            if ($_GET['status'] == 1) {
            ...
            if (isset($_GET['verification'])) {
                ...
                echo '<div class="col-xs-12 bg-yellow1 b" style="padding:18px 18px 10px;">
                            <p class="size20 size18-xs">' . $modelUser['firstname'] . '&nbsp;' . $modelUser['lastname'] . '</p>
                      </div>';
                echo '<div class="col-xs-12 bg-white size18 b" style="padding: 20px;">';
