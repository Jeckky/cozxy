...
<?php if (\Yii::$app->user->id) { ?>
    <li class="has-submenu pull-right"><a href="<?php echo Yii::$app->homeUrl; ?>how-cost-fit-works"   style="color: rgba(255,212,36,.9);">Current Point : <?php
            $UserPoint = common\models\costfit\UserPoint::find()->where('userId=' . \Yii::$app->user->id)->one();
            if (isset($UserPoint)) {
                echo $UserPoint->currentPoint;
            }
            ?> </a></li>
<?php } ?>
