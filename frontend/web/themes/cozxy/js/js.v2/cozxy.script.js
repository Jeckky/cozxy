$(function() {
	$('.topbar .dismiss').on('click touchstart', function(){$('.topbar').slideUp();$('.topOpener').slideDown();return false;});
	$('.topOpener').on('click touchstart', function(){$('.topbar').slideDown();$('.topOpener').slideUp();});
	$('.gotoTop').on('click touchstart', function(){$('html,body').animate({scrollTop:0});return false;});
	// Scroll Script
	...
	// Category Script (PC)
	$('.menu-category').on('click touchstart', function(){categoryOff();$(this).addClass('active');});
	...
	$('.mobcategories').on('click touchstart', function(){
