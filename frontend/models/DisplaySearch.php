    ...
    public static function productSearch($search_hd, $n, $cat = FALSE) {
        ...
        if ($search_hd !== '') {
            $pCanSale = \common\models\costfit\ProductSuppliers::find()
                    ...
                    ->where("p.status=1 and p.approve='approve' and product_price_suppliers.result > 0 and product_price_suppliers.price > 0")
                    ...
                    ->andFilterWhere(['OR',
                        ...
                        ['LIKE', 'strip_tags(p.description)', trim($search_hd)],
