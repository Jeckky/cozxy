...
<div class="row">
    <div class="form-group col-lg-6 col-md-6 col-sm-6">
        ...
        <?= Html::textInput("Address[firstname]", NULL, ["class" => "form-control input-sm", 'required' => 'required', 'placeHolder' => 'First name']) ?>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-sm-6">
        ...
        <?= Html::textInput("Address[lastname]", NULL, ["class" => "form-control input-sm", 'required' => 'required', 'placeHolder' => 'Last name']) ?>
    </div>
</div>
<div class="form-group">
    ...
    <?= Html::textInput("Address[company]", NULL, ["class" => "form-control input-sm", 'required' => 'required', 'placeHolder' => 'Company name']) ?>
</div>
<div class="form-group">
    ...
    <?= Html::textarea("Address[address]", NULL, ["class" => "form-control input-sm", 'required' => 'required', 'rows' => 3, 'placeHolder' => 'Address']) ?>
</div>
<!--<div class="form-group">
...
<div class="row">
    <div class="form-group col-lg-6 col-md-6 col-sm-6">
        ...
        <?= Html::textInput("Address[email]", NULL, ["class" => "form-control input-sm", 'required' => 'required', 'placeHolder' => 'Email adress']) ?>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-sm-6">
        ...
        <?= Html::textInput("Address[tel]", NULL, ["class" => "form-control input-sm", 'required' => 'required', 'placeHolder' => 'Phone number']) ?>
    </div>
</div>
...
if (isset($isUpdate)) {
    ...
    echo Html::submitButton("Save", ['class' => (isset($type) && $type == 1) ? "btn btn-success createBillingSave" : "btn btn-success createShippingSave"]);
