                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-xs-12" style="margin-bottom: 10px;  background-color: #ffffff; padding: 5px;">
                            <?php
                            echo $this->render('picking_point', ['LockerHistory' => $LockerHistory, 'BoothHistory' => $BoothHistory, 'CheckValuePickPoint' => $CheckValuePickPoint, 'address' => $address, 'GetOrderMastersGroup' => $GetOrderMastersGroup, 'pickingPointBooth' => $pickingPointBooth, 'pickingPointLockers' => $pickingPointLockers, 'pickingPointLockersCool' => $pickingPointLockersCool]);
                            ?>
                        </div>
                        <div class="form-group" style="margin-bottom: 10px;  background-color: #f5f5f5; padding: 5px;">
                            <label class="ship-to-dif-adress" style="margin-bottom:0px;">
