...
<!--                    <tr>
                    ...
                    foreach ($wishlists as $wishlist):
                        if (isset($wishlist->productSuppliers)) {
                            ...
                            <td class="name" style="font-size: 14px;padding:5px">
                ...
                foreach ($notInWislist as $productSupp):
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="tile">
                            ...
                            <div class="price-label"><?//= number_format(common\models\costfit\ProductSuppliers::productPriceSupplier($productSupp->productSuppId), 2) ?>
                                <?php
                                if (number_format(common\models\costfit\ProductSuppliers::productPriceSupplier($productSupp->productSuppId), 2) == '0.00') {
                                    echo '';
                                } else {
                                    echo number_format(common\models\costfit\ProductSuppliers::productPriceSupplier($productSupp->productSuppId), 2);
                                }
                                ?>
                            </div>
