<h3 class="b"><?= strtoupper('category') ?> :: <?= strtoupper($category) ?> (RECOMMENDED)
    <small>
        Sort by price&nbsp;<a href="javascript:"><i class="fa fa-angle-down" aria-hidden="true"></i></a>
        Sort by brand&nbsp;<a href="javascript:"><i class="fa fa-angle-down" aria-hidden="true"></i></a>
        Sort by new product&nbsp;<a href="javascript:"><i class="fa fa-angle-down" aria-hidden="true"></i></a>
    </small>
</h3>
