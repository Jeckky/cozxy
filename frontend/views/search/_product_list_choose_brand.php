        ...
        <?php if (isset($promotions) && $promotions->getCount() > 0): ?>
            <div class="filter-product-cozxy col-sm-12">
                <h3 class="b text-center-sm text-center-xs">
                    ...
                    <?php if (isset($promotions) && $promotions->getCount() > 0): ?>
                        <small>
                            <a href="javascript:sortCozxy('<?= $search; ?>','price')" style="color: #000;">Sort by price&nbsp;<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            <input type="hidden" name="Sortprice" id="Sortprice" value="<?= $sortPrice ?>">
                            <span style="color: #fc0;">|</span><a href="javascript:sortCozxySearch('<?= $search; ?>','brand')" style="color: #000;">Sort by brand&nbsp;<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            <input type="hidden" name="Sortbrand" id="Sortbrand" value="<?= $sortBrand ?>">
                            <span style="color: #fc0;">|</span><a href="javascript:sortCozxySearch('<?= $search; ?>','new')" style="color: #000;">Sort by new product&nbsp;<i class="fa fa-angle-down" aria-hidden="true"></i></a>
...
<h3 class="b"><?= strtoupper('category') ?> RECOMMENDED:: <?= strtoupper($category) ?>
    <?php if (isset($promotions) && $promotions->getCount() == 0): ?>
        <small>
            <a href="javascript:sortCozxy('<?= $search; ?>','price')" style="color: #000;"><?= $sortPriceIcon ?></a>
            <span style="color: #fc0;">|</span><a href="javascript:sortCozxySearch('<?= $search; ?>','brand')" style="color: #000;"><?= $sortBrandIcon ?></a>
            <span style="color: #fc0;">|</span><a href="javascript:sortCozxySearch('<?= $search; ?>','new')" style="color: #000;"><?= $sortNewIcon ?></a>
