...
?>
<h3 class="b">RECOMMENDED:: <?= strtoupper($search) ?>
    <small>
        <a href="javascript:sortCozxySearch('<?= $search; ?>','price')" style="color: #000;"><?= $sortPriceIcon ?></a>
        <span style="color: #fc0;">|</span>
        <a href="javascript:sortCozxySearch('<?= $search; ?>','brand')" style="color: #000;"><?= $sortBrandIcon ?></a>
        <a href="javascript:sortCozxySearch('<?= $search; ?>','new')" style="color: #000;"><?= $sortNewIcon ?></a>
...
<div class="row">
    <div class="wf-container">
        <?= yii\helpers\Html::hiddenInput("search", $search); ?>
...
<h3 class="b">PRODUCT :: <?= strtoupper($search) ?> </h3>
<div class="row">
    <div class="wf-container">
        <?= yii\helpers\Html::hiddenInput("search", $search); ?>
