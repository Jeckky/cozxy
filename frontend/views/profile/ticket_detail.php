...
<div class="row cs-page">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <a href="<?= $baseUrl . 'returning' ?>" class="btn-lg pull-right"  style="margin-right: 5px;background-color: #ffcc00;color: #000;"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back</a>
    </div>
    <!-- Zone left -->
