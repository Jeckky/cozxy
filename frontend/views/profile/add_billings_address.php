...
<p style="font-size: 12px;">
    ...
    echo '<a href="' . Yii::$app->homeUrl . 'profile/billings-address/' . \common\models\ModelMaster::encodeParams(['addressId' => $model->addressId]) . '"><span style ="color:#b11010; cursor: hand;" > (edit ,</span></a>';
