...
echo Html::hiddenInput("ship_to_address_city", $model->billingCities->localName);
echo Html::hiddenInput("ship_to_address_country", "TH");
echo Html::hiddenInput("ship_to_address_line1", $model->billingAddress);
echo Html::hiddenInput("ship_to_address_line2", "");
echo Html::hiddenInput("ship_to_address_postal_code", $model->billingZipcode);
echo Html::hiddenInput("ship_to_address_state", $model->billingProvince->localName);
...
echo Html::hiddenInput("ship_to_phone", $model->billingTel);
