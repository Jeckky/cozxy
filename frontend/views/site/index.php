...
<section class="catalog-grid">
    ...
    <!--Features Tabs-->
    <section class="feature-tabs " style="background-color: #ccc;padding-top: 0px">
        <div class="container " >
            <div class="row" >
                <?php
                $i = 1;
                foreach ($bottomContent as $content) {
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <img class="col-lg-12 img-responsive" src="<?= Yii::$app->homeUrl . $content->image; ?>" style="margin-top: 10px" />
                        <h2 style="color:black;text-align: center">
                            <?php echo $content->title; ?>
                        </h2>
                        <hr style="border-color: yellow;border-width: 3px;width:70%" >
