            ...
            <div class="ms-slide" data-delay="7" style="background-image: url('<?= $baseUrl . $banner->image ?>');background-size: 100% 100%;">
                ...
                <div class="ms-anim-layers">
                    <div class="ms-layer text-block" style="margin: 50px; padding: 108px 0px 0px 25px; font-size: 16px; line-height: 22px;">
                        <h2 style="width: 756px; left: 110px; top: 110px;" class="dark-color ms-layer" data-effect="top(50,true)" data-duration="700" data-delay="250" data-ease="easeOutQuad">
                            <span><?= $banner->headTitle ?></span>
                            <br><?= $banner->title ?>
                        </h2>
                        <?php
                        ...
                        <p style="width: 456px; left: 110px; top: 310px;" class="dark-color ms-layer col-md-7 " data-effect="back(500)" data-duration="700" data-delay="500" data-ease="easeOutQuad"><?= $desc; ?></p>
...
<section class="catalog-grid">
    <div class="container">
        <h2 class="dark-color">EXPLORE</h2>
        <div class="row">
            <?php
            echo \yii\widgets\ListView::widget([
