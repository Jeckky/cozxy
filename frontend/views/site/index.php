                    ...
                    <?php foreach ($product2 as $item) {
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <a class="media-link" href="#">
                                <div class="overlay">
                                    <div class="descr"><div><?php echo $item->title; ?><span><?php echo isset($item->productOnePrice) ? $item->productOnePrice->price : $item->price; ?></span></div></div>
                                </div>
                                <?php if (isset($item->productImages[0]->image) && !empty($item->productImages[0]->image)): ?>
                                    <img src="<?php echo Yii::$app->homeUrl . $item->productImages[0]->image; ?>" alt="1" title="ขนาด 555 x 245"/>
                                <?php else: ?>
