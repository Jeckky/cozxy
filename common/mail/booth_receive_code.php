...
<div class="main">
    <div class="main-leyouts">
        <div class="head title" style=" background-color: #000000; color: rgba(255,212,36,.9); padding: 20px;">
            <span style="color:  rgba(255,212,36,.9); ">COZXY RECEIVE CODE</span>
        </div>
        <div class="content" style="background-color: #f5f5f5;">
            <h1 style="text-align: center;">Order No. : <?=$orderNo?></h1>

            <div style="width:400px;padding:20px;margin-left: auto;margin-right: auto;font-size: 30px;text-align: center;color:red;">
                CODE : <?=$receiveCode?>
            </div>
        </div>
