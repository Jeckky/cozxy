...
*
    ...
    * @property string $shippintDiscountValue
...
return [
            ...
            [['priceOnePiece', 'quantity', 'price', 'subTotal', 'discountValue', 'shippintDiscountValue', 'total'], 'number'],
...
return [
    ...
    'shippintDiscountValue' => Yii::t('order_item', 'Shippint Discount Value'),
