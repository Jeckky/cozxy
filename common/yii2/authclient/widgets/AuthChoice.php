...
namespace common\yii2\authclient\widgets;
...
//                $text.= "<i class='soap-icon-" . $client->getName() . "'></i>" . "Login with " . ucfirst($client->getName());
                $text.="<i class='fa fa-google-plus-square'></i>";
            } else {
//                $text.= "<i class='soap-icon-" . $client->getName() . "plus'></i>" . "Login with " . ucfirst($client->getName());
                $text.="<i class='fa fa-facebook-square'></i>";
            }
        }
        if (!array_key_exists('class', $htmlOptions)) {
//            $htmlOptions['class'] = 'auth-link ' . $client->getName();
            if ($client->getName() == "google") {
                $htmlOptions['class'] = "google";
            } else {
                $htmlOptions['class'] = "facebook";
            }
        }
...
//        echo Html::beginTag('ul', ['class' => 'auth-clients clear']);
        echo Html::beginTag('div', ['class' => 'login-social']);
...
//        echo Html::endTag('ul');
    ...
    public function init()
    {
        ...
        if ($this->popupMode) {
            \yii\authclient\widgets\AuthChoiceAsset::register($view);
