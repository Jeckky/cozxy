                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function($model) {
                                        return "<form id='form$model->productImageId' name='form$model->productImageId' action='" . Yii::$app->homeUrl . "suppliers/product-image-suppliers/change-sort-order?id=$model->id' method='POST'>"
