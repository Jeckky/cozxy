...
<div class="store-product-index">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                'header'=>'Actions',
                                'template' => '{view} {update} {delete} {product} {storeProductGroup} {store}',
                'buttons'=> [
'product' => function($url, $model) {
                            return Html::a('<br><u>Product</u>', 
['/product/manage', 'storeProductId' => $model->storeProductId], 
[
                                'title' => Yii::t('app', 'Change today\'s lists'),]);},
'storeProductGroup' => function($url, $model) {
                            return Html::a('<br><u>StoreProductGroup</u>', 
['/storeProductGroup/manage', 'storeProductId' => $model->storeProductId], 
[
                                'title' => Yii::t('app', 'Change today\'s lists'),]);},
'store' => function($url, $model) {
                            return Html::a('<br><u>Store</u>', 
['/store/manage', 'storeProductId' => $model->storeProductId], 
[
                                'title' => Yii::t('app', 'Change today\'s lists'),]);},]
                ],
                ],
