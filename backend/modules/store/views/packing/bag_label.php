...
<tbody>
    ...
    <tr>
        ...
        <td style="border-top: #000 solid thin; text-align: right;"><?= number_format(($total - $extraDiscount) * (100 / 107), 2) ?></td>
    </tr>
    <tr>
    </tr>
    <tr>
        <td colspan="2"style="border-right: #000 solid thin;border-top:#000 solid thin;"><b>&nbsp;&nbsp;ภาษีมูลค่าเพิ่ม / VAT 7%</b></td>
        <td style="border-top:#000 solid thin;text-align: right;"><?= number_format((($total - $extraDiscount) - ($total * (100 / 107))), 2) ?></td>
    </tr>
    <tr>
        ...
        <td style = "border-top:#000 solid thin;text-align: right;"><?= number_format($total - $extraDiscount, 2)
    ?></td>
    </tr>
