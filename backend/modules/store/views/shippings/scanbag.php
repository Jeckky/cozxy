            ...
            <div class="panel colourable">
                ...
                if ($bagNo != '') {
                    $form = ActiveForm::begin([
                                'method' => 'GET',
                                'action' => ['shippings/scan-channels?model=' . $model . '&boxcode=' . $listPoint->pickingId . '&pickingItemsId=' . $pickingItemsId . '&bagNo=' . $bagNo],
                    ]);
                    ?>
                    <div class="panel-heading">
                        <span class="panel-title"><i class="fa fa-qrcode" aria-hidden="true"></i> Scan Qr Code ปิดช่องล็อคเกอร์.</span>
                    </div>
                    <div class="panel-body ">
                        <div class="col-sm-12">
                            <input type="text" name="code" autofocus="true" id="code" class="form-control" placeholder="Search or Scan Qr code">
                            <div id="character-limit-input-label" class="limiter-label form-group-margin">หมายเหตุ : <span class="limiter-count">Scan Qr Code.</span></div>
                        </div>
                    </div>
                    <?= $this->registerJS("
                    ...
                    $form = ActiveForm::begin([
                                'method' => 'GET',
                                'action' => ['shippings/scan-bag?model=' . $model . '&code=' . $channel . '&boxcode=' . $listPoint->pickingId . '&pickingItemsId=' . $pickingItemsId],
                    ]);
                    ?>
                    <div class="panel-heading">
                        <span class="panel-title"><i class="fa fa-qrcode" aria-hidden="true"></i> Scan Qr Code ถุงใส่ช่องล็อคเกอร์.</span>
                    </div>
                    <div class="panel-body ">
                        <div class="col-sm-12">
                ...
                <div class="panel-body">
                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            'orderItemPackingId', 'orderItemId',
                            'bagNo',
                            //'orderNo',
                            //'bagNo',
                            //'status',
