    ...
    <div class="panel panel-default">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-xs-12">
                ...
                <table class="table" style="margin-left: 5px;">
                    <tr style="height: 50px;background-color: #999999;">
                        ...
                        <th style="vertical-align: middle;text-align: center;width: 30%;">Receive Date</th>
                ...
                <?php if ($ticket->status == Ticket::TICKET_STATUS_WAIT_COZXY) { ?>
                    <a class="btn-lg pull-right" id="approve-by-cozxy" style="background-color: #000;color: #ffcc00;cursor: pointer;"><i class="fa fa-check-circle-o" aria-hidden="true"></i>Approve</a>
            ...
            <div class="col-lg-5 col-md-5 col-xs-12" id="remark" style="margin-top: 10px;display: none;">
                ...
                <a class="btn-lg pull-right" id="send-remark-cozxy" style="background-color: #000;color: #ffcc00;cursor: pointer;"><i class="fa fa-check-circle-o" aria-hidden="true"></i> OK</a>
