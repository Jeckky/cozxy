...
<div class="brand-form">
    ...
    <div class="panel-body">
        ...
        <?= $form->field($model, 'parentId', ['options' => ['class' => 'row form-group']])->dropDownList(ArrayHelper::map(common\models\costfit\Brand::find()->all(), 'brandId', 'title'), ['prompt' => '-- Select Parent --']) ?>
