...
<div class="panel panel-default" >
    ...
    <div class="panel-body">
                        ...
                        foreach ($allOption as $value):
                            ...
                            <tr>
                                <td style="border: white solid thin;">
                                    ...
                                    <a class="btn btn-success"  id="save<?= $value->productGroupOptionValueId ?>"href="javascript:saveEdit(<?= $value->productGroupOptionValueId ?>);" style="display: none;"><i class="fa fa-check" aria-hidden="true"></i> Save</a>
                                </td>
                            </tr>
                            <?php
                        endforeach;
        ...
        ?>
        <div class="col-lg-12 col-lg-12" style="border: silver solid thin;padding-bottom: 30px;">
                ...
                if (isset($options) && count($options) > 0) {
                    foreach ($options as $templateOptionId => $option):
                        ...
                        <div class="col-lg-3 col-md-3">
                            <h4><?= $option ?></h4>
                            <input type="text" name="newProduct[<?= $templateOptionId ?>]" class=" form-control" style="height: 40px;">
                        </div>
