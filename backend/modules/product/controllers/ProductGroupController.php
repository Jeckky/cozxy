...
//                    } else {
                    if (isset($model->step)) {
                        return $this->redirect(['create', 'step' => isset($_GET["step"]) ? $_GET["step"] : $model->step, 'productGroupTemplateId' => $model->productGroupTemplateId, 'productGroupId' => $model->productId]);
                    }
//                    }
                }
