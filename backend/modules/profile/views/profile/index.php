                ...
                <div class="profile-content">
                    ...
                    <div class="tab-content tab-content-bordered panel-padding">
                        <div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-board">
                            ...
                            <div class="comment">
                                <img src="<?php echo $directoryAsset; ?>/demo/avatars/1.jpg" alt="" class="comment-avatar">
                            ...
                            <div class="comment">
                                <img src="<?php echo $directoryAsset; ?>/demo/avatars/2.jpg" alt="" class="comment-avatar">
                                <div class="comment-body">
                                ...
                                <div class="comment">
                                    <img src="<?php echo $directoryAsset; ?>/demo/avatars/4.jpg" alt="" class="comment-avatar">
                                    <div class="comment-body">
                                        <div class="comment-text">
                                            <div class="comment-heading">
                                ...
                                <div class="comment">
                                    <img src="<?php echo $directoryAsset; ?>/demo/avatars/5.jpg" alt="" class="comment-avatar">
                                    <div class="comment-body">
                                        <div class="comment-text">
                                            <div class="comment-heading">
                            ...
                            <div class="comment">
                                <img src="<?php echo $directoryAsset; ?>/demo/avatars/3.jpg" alt="" class="comment-avatar">
                                <div class="comment-body">
                                    <div class="comment-text">
                                        <div class="comment-heading">
                        ...
                        <div class="tab-pane fade" id="profile-tabs-activity">
                            <div class="timeline">
                                ...
                                <div class="tl-entry left">
                                    ...
                                    <div class="panel tl-body">
                                        ...
                                        <div class="tl-wide text-center" style="padding: 10px;margin-top:15px;margin-bottom: 15px;background: #f1f1f1">
                                            <img src="<?php echo $directoryAsset; ?>/demo/signin-bg-5.jpg" alt="" style="max-height: 150px;max-width: 100%;">
                                        </div>
                                ...
                                <div class="tl-entry">
                                    ...
                                    <div class="tl-icon bg-success"><img src="<?php echo $directoryAsset; ?>/demo/avatars/2.jpg" alt=""></div>
                                    <div class="panel tl-body">
                                ...
                                <div class="tl-entry left">
                                    ...
                                    <div class="panel tl-body">
                                        <img src="<?php echo $directoryAsset; ?>/demo/avatars/5.jpg" alt="" class="rounded" style=" width: 20px;height: 20px;margin-top: -2px;">&nbsp;&nbsp;<a href="#">Denise Steiner</a> followed <a href="#">Johg Doe</a>
                                    </div> <!-- / .tl-body -->
                                </div> <!-- / .tl-entry -->
                                ...
                                <div class="tl-entry">
                                    ...
                                    <div class="panel tl-body">
                                        ...
                                        <div style="margin-top: 10px;" class="text-sm">
                                            <img src="<?php echo $directoryAsset; ?>/demo/avatars/3.jpg" alt="" class="rounded" style=" width: 20px;height: 20px;margin-top: -2px;">&nbsp;&nbsp;<a href="#">Michelle Bortz</a> commented 2 days ago
                        ...
                        <div class="tab-pane fade widget-followers" id="profile-tabs-followers">
                            <div class="follower">
                                <img src="<?php echo $directoryAsset; ?>/demo/avatars/1.jpg" alt="" class="follower-avatar">
                                <div class="body">
                            ...
                            <div class="follower">
                                <img src="<?php echo $directoryAsset; ?>/demo/avatars/3.jpg" alt="" class="follower-avatar">
                                <div class="body">
                                    <div class="follower-controls">
                            ...
                            <div class="follower">
                                <img src="<?php echo $directoryAsset; ?>/demo/avatars/4.jpg" alt="" class="follower-avatar">
                                <div class="body">
                                    <div class="follower-controls">
                                        <a href="#" class="btn btn-sm btn-outline">Follow</a>
                                    </div>
                            ...
                            <div class="follower">
                                <img src="<?php echo $directoryAsset; ?>/demo/avatars/5.jpg" alt="" class="follower-avatar">
                                <div class="body">
                                    <div class="follower-controls">
                                        <a href="#" class="btn btn-sm btn-outline">Follow</a>
                                    </div>
