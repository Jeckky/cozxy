...
?>
<h1>CSV Importer <span class="text-danger">Product</span> to Database</h1>
    ...
    <div class="row">
        ...
        <div class="panel ">
            <div class="panel-heading ">
                <span class="panel-title"><i class="fa fa-th-large"></i> Upload CSV Importer Product to Database</span>
            </div>
