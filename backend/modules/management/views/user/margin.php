...
<div class="panel-body">
    ...
    <?= $form->field($model, 'percent', ['options' => ['class' => 'row form-group ']])->textInput(['maxlength' => 13])->label('Current Margin (%)') ?>
        ...
        <div class="col-lg-10 col-lg-offset-2">
            <div class="panel panel-info">
                ...
                <div id="collapse1" class="panel-collapse collapse">
                    <?php
                    $historys = \common\models\costfit\Margin::find()->where("supplierId = " . $_GET["supplierId"])->orderBy("createDateTime DESC")->all();
                    ?>
    ...
    <?php
    $form = ActiveForm::begin([
        'action' => Yii::$app->homeUrl . "management/user",
        'method' => "POST",
        'options' => ['class' => 'panel panel-default form-horizontal', 'enctype' => 'multipart/form-data'],
        'fieldConfig' => [
            'template' => '{label}<div class="col-sm-7">{input}</div>',
    ...
    ?>
    <?= Html::hiddenInput("type", 4); ?>
    <?= Html::submitButton("Back", ['class' => 'btn btn-danger pull-right btn-lg']) ?>
    <?php ActiveForm::end(); ?>
</div>
