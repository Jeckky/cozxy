            ...
            <div class="panel-body">
                <div class="panel colourable panel-info">
                    ...
                    $form = ActiveForm::begin([
                                'method' => 'GET',
                                'action' => ['scan-bag?model=' . $model . '&code=' . $channel . '&boxcode=' . $listPoint->pickingId . '&pickingItemsId=' . $pickingItemsId . '&orderId=' . $orderId . '&orderItemPackingId=' . $orderItemPackingId, 'orderItemId=' . $model->orderItemId],
                    ]);
                    ?>
                    <div class="panel-heading">
