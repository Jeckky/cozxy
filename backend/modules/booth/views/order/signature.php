...
<div style="width: 747px;">
    <div style="float: left;width: 28%;height: 125px; border:solid 0.5px #000000;border-radius:10px; padding-top: 10px;padding-left: 20px;border-top-right-radius: 10px;border-top-left-radius: 10px;font-size: 10px;padding-bottom: 15px;">
    ...
    <div style="float: left;width: 28%;height: 125px; border:solid 0.5px #000000;border-radius:10px; padding-top: 10px;padding-left: 20px;border-top-right-radius: 10px;border-top-left-radius: 10px;font-size: 10px;padding-bottom: 15px;margin-left: 25px;">
