    ...
    <div class="panel colourable">
        <div class="panel-heading">
            ...
            <div class="panel-heading-controls">
                <?= Html::a('Update', ['update', 'id' => $model->orderItemId], ['class' => 'btn btn-xs btn-primary btn-outline']) ?>
                <?= Html::a('Delete', ['delete', 'id' => $model->orderItemId], [
